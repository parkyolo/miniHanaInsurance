...
// app.get('/signupPage.css', (req, res) => {
//     res.sendFile(path.join(__dirname,  'signupPage.css'));
//   });
...
// app.get('/icon_reward_04.png', (req, res) => {
//     res.sendFile(path.join(__dirname,  'icon_reward_04.png'));
//   });
